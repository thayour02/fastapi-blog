...
POSTS = [
    ...
    {
        "title": "The Beauty of Response model",
        "content": "Response model aren't just for documentation - they filter out sensitive fields automatically. Define what goes out, and Pydantic handles the rest.",
    },
    {
    ...
    },
    {
        ...
        "content": "Add docstrings to your endpoints and they appear in Swagger UI. Add examples to your Pydantic model and they show up too. Documentation has never been this easy.",
    },
    {
